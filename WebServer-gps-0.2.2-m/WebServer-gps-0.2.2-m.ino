    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.print("Hi Mikayla, Curt, and Adam, this is an itty bitty little web server that prints the output of the analong pins on an Arduino:<br>");
          for (int analogChannel = 0; analogChannel < 6; analogChannel++) {
            ...
            {
              client.print(F(" ACQUIRING SATELITES "));
            }
            ...
            else
            {
              ...
              client.print(":");  
              chophours = printDigits(hours);
              client.print(chophours);
              client.print(":"); 
              chopminute = printDigits(minutes); 
              client.print(chopminute);
              client.print(":");
              chopseconds = printDigits(seconds);
              client.print(chopseconds);
              client.println("<br");  
